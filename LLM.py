...
def call_ollama_model(message, model="llama3.2:latest"):
    ...
    try:
        ...
        return response.json()['response']  # key is 'response' not 'message'
...
if page == "Chat":
    ...
    if st.session_state.pending_input:
        ...
        bot_reply = call_ollama_model(st.session_state.pending_input)
